  ...
  test "should encode transaction according to encoding rules" {
    try {
      ...
      assets =
        [
          Asset(
            "dd0682e21dffaa39ecc23074c483c07d4524f0f2fce065687a78d7ec51fefdf5",
            "name",
            "description",
            "media_location",
            "media_hash",
